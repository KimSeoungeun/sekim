...
$(window).on('load', function () {
  ...
  $(window).scroll(function () {
    var scrollTop = $('html, body').scrollTop();
    var slideImage1 = $('.MainBox div:nth-child(1)').offset().top;
    var slideImage2 = $('.MainBox div:nth-child(2)').offset().top;
    var slideImage3 = $('.MainBox div:nth-child(3)').offset().top;
    var slideImage4 = $('.MainBox div:nth-child(4)').offset().top;
    var slideImage5 = $('.MainBox div:nth-child(5)').offset().top;
    var slideImage6 = $('.MainBox div:nth-child(6)').offset().top;
  ...
  $('.Startbutton').on('click', function () {
    var slideImage1 = $('.AboutBox').offset().top;
    $('html, body').animate({
  ...
  $('.Continue_button').on('click', function () {
    var figureImage1 = $('.figure_1').offset().top;
    $('.MainBox div:nth-child(1)').css('width', '1100px');
    $('html, body').animate({
  ...
  $('.Continue_button1').on('click', function () {
    var figureImage2 = $('.figure_2').offset().top;
    $('.MainBox div:nth-child(2)').css('width', '1100px');
    $('html, body').animate({
  ...
  $('.Continue_button2').on('click', function () {
    var figureImage3 = $('.figure_3').offset().top;
    $('.MainBox div:nth-child(3)').css('width', '1100px');
    $('html, body').animate({
  ...
  $('.Continue_button3').on('click', function () {
    var figureImage4 = $('.figure_4').offset().top;
    $('.MainBox div:nth-child(4)').css('width', '1100px');
    $('html, body').animate({
  ...
  $('.Continue_button4').on('click', function () {
    var figureImage5 = $('.figure_5').offset().top;
    $('.MainBox div:nth-child(5)').css('width', '1100px');
    $('html, body').animate({
  ...
  $('.Continue_button5').on('click', function () {
    var figureImage6 = $('.figure_6').offset().top;
    $('html, body').animate({
  ...
  $('.Continue_button6').on('click', function () {
    var figureImage6 = $('.Bravo').offset().top;
    $('html, body').animate({
      scrollTop: figureImage6
    }, 500);
    page = 8;
