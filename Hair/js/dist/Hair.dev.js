...
$(window).on('load', function () {
  ...
  $(window).scroll(function () {
    var html = $('html, body').scrollLeft();
    var offset1 = $('#s1').offset().left;
    var offset2 = $('#s2').offset().left;
    var offset3 = $('#s3').offset().left;
    var offset4 = $('#s4').offset().left;
    var offset5 = $('#s5').offset().left;
    var offset6 = $('#s6').offset().left;
    var offset7 = $('#s7').offset().left;
